...
var TYPED_ARRAY_SUPPORTED = function (typeName) { return typeof TYPED_ARRAY_CTORS[typeName] === 'function'; };
...
var builtInTransforms = [
    ...
    },
    {
        type: '[[TypedArray]]',
        shouldTransform: function (type, val) {
            for (var _i = 0, _a = Object.entries(TYPED_ARRAY_CTORS); _i < _a.length; _i++) {
                var _b = _a[_i], ctorName = _b[0], ctor = _b[1];
